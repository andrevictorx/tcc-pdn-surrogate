...
experimentais próprias. Essa escolha é deliberada: o uso de uma base simulada e
validada por terceiros, com propriedades físicas conhecidas e verificáveis,
elimina do caminho crítico do trabalho os riscos associados à instrumentação e
à caracterização de incerteza de medições próprias.
