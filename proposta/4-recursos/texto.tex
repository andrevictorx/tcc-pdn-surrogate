...
Engenharia Elétrica da UFPR e do PPGEE/UFPR. Prevê-se interlocução pontual com o
Prof.\ Dr.\ Bruno Pohlot Ricobom no que se refere ao escâner de campo próximo,
caso a validação experimental complementar descrita na
Seção~\ref{sec:validacao_exp} venha a ser realizada. Registre-se que essa
interlocução tem caráter de apoio técnico pontual e não constitui coorientação
formal; o trabalho não prevê coorientador, conforme declarado na página de
identificação.

Estima-se dedicação de vinte horas semanais ao longo de dois semestres letivos,
